...
import com.example.autopilot.MainController.MotorsPowers;
...
public class AdkCommunicator implements Runnable {
            ...
            if (ACTION_USB_PERMISSION.equals(action)) {
                synchronized (this) {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false)) {
                        ...
                        ((QuadcopterActivity) context).updateAccessoryConnectionStatus("Permission Denied");
                    }
    ...
    public void start(boolean continuousMode) throws Exception {
        ...
        if (accessory != null) {
            ...
            ((QuadcopterActivity) context).updateAccessoryConnectionStatus("Not Connected");
        }
    }
    ...
    private void openAccessory(UsbAccessory accessory) {
        ...
        if (fileDescriptor != null) {
            ...
            rxThread.start();
            ((QuadcopterActivity) context).updateAccessoryConnectionStatus("Connected");
    ...
    private void closeAccessory() {
        ...
        try {
            ...
            fileDescriptor = null;
            usbAccessory = null;
            ((QuadcopterActivity) context).updateAccessoryConnectionStatus("Detached");
        }
    }
